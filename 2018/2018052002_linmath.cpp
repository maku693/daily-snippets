...
template <class T>
mat<T, 4, 4> rotate(const vec<T, 3>& axis, T theta)
{
  ...
  return {
    axis[0] * axis[0] * a + ct,
    axis[0] * axis[1] * a + axis[1]st,
    axis[0] * axis[2] * a + axis[2]st,
    1,
    axis[1] * axis[0] * a + axis[2]st,
    axis[1] * axis[1] * a + ct,
    axis[1] * axis[2] * a + axis[0]st,
    1,
    axis[2] * axis[0] * a + axis[1]st,
    axis[2] * axis[1] * a + axis[0]st,
    axis[2] * axis[2] * a + ct,
    1,
    1, 1, 1, 1
  };
