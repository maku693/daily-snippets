...
template <class T>
struct is_vec : private std::is_base_of<vec_operators, T> {};
...
struct vec2 : private vec_operators<vec2> {
    float x = 0.0f;
    float y = 0.0f;
...
struct vec3 : private vec_operators<vec3> {
    float x = 0.0f;
    float y = 0.0f;
    float z = 0.0f;
...
struct vec4 : private vec_operators<vec4> {
    float x = 0.0f;
    float y = 0.0f;
    float z = 0.0f;
    float w = 0.0f;
