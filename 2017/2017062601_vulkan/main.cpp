...
int WINAPI wWinMain(HINSTANCE hInstance, HINSTANCE, PWSTR, int)
{
    ...
    const auto surfaceFormat = ([&physicalDevice, &surface] {
    ...
    const auto swapchain = ([&physicalDevice, &device, hWnd, &surface, &queueFamilyIndices, &surfaceFormat] {
    ...
    const auto buffers = ([&device, &surfaceFormat, &swapchain] {
