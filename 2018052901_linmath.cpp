...
struct mat4 : private equatable<mat4>, private multipliable<mat4> {
  ...
  constexpr mat4(float m00, float m01, float m02, float m03, float m10,
  ...
  constexpr mat4 &operator*=(const mat4 &rhs) noexcept {
    float m00 = data[0][0] * rhs[0][0] + data[0][1] * rhs[1][0] +
                data[0][2] * rhs[2][0] + data[0][3] * rhs[3][0];
    float m01 = data[0][0] * rhs[0][1] + data[0][1] * rhs[1][1] +
                data[0][2] * rhs[2][1] + data[0][3] * rhs[3][1];
    float m02 = data[0][0] * rhs[0][2] + data[0][1] * rhs[1][2] +
                data[0][2] * rhs[2][2] + data[0][3] * rhs[3][2];
    float m03 = data[0][0] * rhs[0][3] + data[0][1] * rhs[1][3] +
                data[0][2] * rhs[2][3] + data[0][3] * rhs[3][3];
    float m10 = data[1][0] * rhs[0][0] + data[1][1] * rhs[1][0] +
                data[1][2] * rhs[2][0] + data[1][3] * rhs[3][0];
    float m11 = data[1][0] * rhs[0][1] + data[1][1] * rhs[1][1] +
                data[1][2] * rhs[2][1] + data[1][3] * rhs[3][1];
    float m12 = data[1][0] * rhs[0][2] + data[1][1] * rhs[1][2] +
                data[1][2] * rhs[2][2] + data[1][3] * rhs[3][2];
    float m13 = data[1][0] * rhs[0][3] + data[1][1] * rhs[1][3] +
                data[1][2] * rhs[2][3] + data[1][3] * rhs[3][3];
    float m20 = data[2][0] * rhs[0][0] + data[2][1] * rhs[1][0] +
                data[2][2] * rhs[2][0] + data[2][3] * rhs[3][0];
    float m21 = data[2][0] * rhs[0][1] + data[2][1] * rhs[1][1] +
                data[2][2] * rhs[2][1] + data[2][3] * rhs[3][1];
    float m22 = data[2][0] * rhs[0][2] + data[2][1] * rhs[1][2] +
                data[2][2] * rhs[2][2] + data[2][3] * rhs[3][2];
    float m23 = data[2][0] * rhs[0][3] + data[2][1] * rhs[1][3] +
                data[2][2] * rhs[2][3] + data[2][3] * rhs[3][3];
    float m30 = data[3][0] * rhs[0][0] + data[3][1] * rhs[1][0] +
                data[3][2] * rhs[2][0] + data[3][3] * rhs[3][0];
    float m31 = data[3][0] * rhs[0][1] + data[3][1] * rhs[1][1] +
                data[3][2] * rhs[2][1] + data[3][3] * rhs[3][1];
    float m32 = data[3][0] * rhs[0][2] + data[3][1] * rhs[1][2] +
                data[3][2] * rhs[2][2] + data[3][3] * rhs[3][2];
    float m33 = data[3][0] * rhs[0][3] + data[3][1] * rhs[1][3] +
...
constexpr vec4 operator*(const mat4 &lhs, const vec4 &rhs) noexcept {
  return {lhs[0][0] * rhs.x + lhs[0][1] * rhs.y + lhs[0][2] * rhs.z + lhs[0][3] * rhs.w,
...
mat4 make_identity() noexcept {
  mat4 x{};
  x[0][0] = x[1][1] = x[2][2] = x[3][3] = 1;
  return x;
}

mat4 make_translate(const vec3 &v) noexcept {
...
int main() {
  ...
  const auto v1 = make_translate({0, 0, 0}) * vec4{1, 2, 3, 0};
